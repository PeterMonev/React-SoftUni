          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <div className="input-wrapper">
                  ...
                  <input id="city" name="city" type="text" value={values.city} onChange={changeHandler} onBlur={(e) => minLength(e, 2 )}/>
                </div>
                {errors.city &&
                <p className="form-error">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <div className="input-wrapper">
                  <span><i className="fa-solid fa-map"></i></span>
                  <input id="street" name="street" type="text" value={values.street} onChange={changeHandler} onBlur={(e) => minLength(e, 2 )}/>
                </div>
                {errors &&
                <p className="form-error">
